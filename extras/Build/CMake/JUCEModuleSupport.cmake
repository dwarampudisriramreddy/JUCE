...
function(juce_add_module module_path)
    ...
    if(${module_name} STREQUAL "juce_core")
        ...
        elseif(CMAKE_SYSTEM_NAME STREQUAL "Android")
            target_sources(juce_core INTERFACE "${CMAKE_ANDROID_NDK}/sources/android/cpufeatures/cpu-features.c")
            target_include_directories(juce_core INTERFACE "${CMAKE_ANDROID_NDK}/sources/android/cpufeatures")
